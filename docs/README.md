...
| Global GRU baseline | **Complete** — Phases 1–6; frozen reference `experiments/global_gru_reference_2026-07-17/` |
| Cross-architecture comparison | **Complete** — Hybrid vs Global GRU (`experiments/hybrid_vs_global_2026-07-17_095147/`); Hybrid lower mean MAE/RMSE on 99-container cohort |
